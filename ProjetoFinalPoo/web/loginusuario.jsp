             ...
             <main role="main">
                ...
                <br>
                        ...
                        <br><br><br>
                            <div class="card">
                              <div class="card-body">
                                <H2 class="display-4">CADASTRO DE FILMES</H2>
                              </div>
                            </div>
                        </section>
                              ...
                              <div class="jumbotron">
                                  ...
                                  <form action="cadastro_ator.jsp" method="post">
                                    <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="c_email" placeholder="Digite o email">
                                    </div>
                                   <div class="form-group">
                                         <label for="c_pass">Senha</label>
                                         <input type="password" class="form-control" name="c_pass" placeholder="Digite a senha">
                                   </div>
